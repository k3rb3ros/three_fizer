...
#define MAGIC_NUMBER 0x0909202009092009
#define RESERVED 0x7256736572766564
...
uint64_t* gen_header(ThreefishKey_t* key, uint64_t file_size, uint64_t* iv, SkeinSize_t state_size); //generates an encrypted header containing a magic number, the filesize and state side
