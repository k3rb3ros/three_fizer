...
/*
 * Hashes the file @fname to a digest of the state size of the cipher to be used as a key for a threefish operation
 */
uint64_t* hash_key_from_file(const char* fname, const SkeinSize_t state_size);
