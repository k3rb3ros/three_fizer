...
static void testThreefish256NullDecrypt()
{
    ...
    threefishSetKey(&tf_key, Threefish256, three_256_00_key, three_256_00_tweak);
    threefishDecryptBlockWords(&tf_key, three_256_00_expected_result, test_block_256);
...
static void testThreefish512NullDecrypt()
{
    ...
    threefishSetKey(&tf_key, Threefish512, three_512_00_key, three_512_00_tweak);
    threefishDecryptBlockWords(&tf_key, three_512_00_expected_result, test_block_512);
...
static void testThreefish512TVDecrypt()
{
    ...
    threefishSetKey(&tf_key, Threefish512, three_512_01_key, three_512_01_tweak);
    threefishDecryptBlockWords(&tf_key, test_block_512, test_block_512);
...
static void testThreefish1024NullDecrypt()
{
    ...
    threefishSetKey(&tf_key, Threefish1024, three_1024_00_key, three_1024_00_tweak);
    threefishDecryptBlockWords(&tf_key, three_1024_00_expected_result, test_block_1024);
